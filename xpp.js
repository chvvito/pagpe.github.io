...
// Seleccionar el botón "VIEWCART"
let viewCartBtn = document.getElementById("viewCart");

// Función para manejar el clic en el botón "VIEWCART"
viewCartBtn.addEventListener("click", function () {
    if (carrito.length === 0) {
        alert("Tu carrito está vacío. ¡Empieza a comprar ahora!");
    } else {
        alert(`Compra realizada con éxito por un total de $${precio.toFixed(2)}.`);
        vaciar2(); // Limpia el carrito tras la compra
    }
});
